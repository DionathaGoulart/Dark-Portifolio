...
import image1Raw from '@assets/5/1.webp'
import image2Raw from '@assets/5/2.webp'
import image3Raw from '@assets/5/3.webp'
import image4Raw from '@assets/5/4.webp'
import image5Raw from '@assets/5/5.webp'
import image6Raw from '@assets/5/6.webp'
import image7Raw from '@assets/5/7.webp'
import image8Raw from '@assets/5/8.webp'
import image9Raw from '@assets/5/9.webp'
import image10Raw from '@assets/5/10.webp'
import image11Raw from '@assets/5/11.webp'
import image12Raw from '@assets/5/12.webp'
import image13Raw from '@assets/5/13.webp'
import image14Raw from '@assets/5/14.webp'
import image15Raw from '@assets/5/15.webp'
import image16Raw from '@assets/5/16.webp'
import image17Raw from '@assets/5/17.webp'
import image18Raw from '@assets/5/18.webp'
...
const image18 = getImage(`${image18Raw}?as=webp&width=1200`)
  ...
  return (
    <div className="min-h-screen bg-transparent">
      ...
      <section className="py-8 px-6 sm:px-8 lg:px-12">
        ...
        <div className="mb-12 px-20">
          <ImageGrid
            images={[
              ...
              { src: image4, alt: 'Project Two - Imagem 3' }
            ]}
            columns={3}
            aspectRatio="3/4"
            objectFit="cover"
        ...
        <div className="mb-12">
          <ImageGrid
            images={[{ src: image17, alt: 'Project Two - Imagem 4' }]}
            columns={1}
            aspectRatio="16/9"
            objectFit="cover"
            rounded="none"
        ...
        <div className="mb-12">
          <ImageGrid
            images={[{ src: image15, alt: 'Project Two - Imagem 9' }]}
            columns={1}
            aspectRatio="3/2"
            objectFit="cover"
            rounded="none"
        ...
        <div className="mb-12">
          <ImageGrid
            images={[{ src: image13, alt: 'Project Two - Imagem 10' }]}
            columns={1}
            aspectRatio="3/4"
            objectFit="cover"
            rounded="none"
        ...
        <div className="mb-12">
          <ImageGrid
            images={[
              { src: image8, alt: 'Project Two - Imagem 11' },
              { src: image12, alt: 'Project Two - Imagem 12' }
            ]}
            columns={2}
            aspectRatio="16/9"
            objectFit="cover"
        ...
        <div className="mb-12">
          <ImageGrid
            images={[{ src: image16, alt: 'Project Two - Imagem 13' }]}
            columns={1}
            aspectRatio="3/2"
            objectFit="cover"
            rounded="none"
        ...
        <div className="mb-12">
          <ImageGrid
            images={[{ src: image18, alt: 'Project Two - Imagem 17' }]}
            columns={1}
            aspectRatio="3/4"
            objectFit="cover"
            rounded="none"
        ...
        <div className="mb-12">
          <ImageGrid
            images={[
              { src: image5, alt: 'Project Two - Imagem 15' },
              { src: image10, alt: 'Project Two - Imagem 16' }
            ]}
            columns={2}
            aspectRatio="3/2"
            objectFit="cover"
        ...
        <div className="mb-12">
          <ImageGrid
            images={[{ src: image14, alt: 'Project Two - Imagem 17' }]}
            columns={1}
            aspectRatio="1/1"
            objectFit="cover"
            rounded="none"
